...
export class AfvalRondePlanner extends Base implements OnInit {
    ...
    prevAfvalRonde: SpeelRonde = new SpeelRonde(0, '', '', 0, '');
    prevPouleRonde: SpeelRonde = new SpeelRonde(0, '', '', 0, '');
    ...
    //         return;
    //     }
    //     let dagToAdd = new SpeelDag(this.ronde.maxMatchesPerDag);
    ...
    //     const matchIngepland = this.ronde.speelDagen[idxDag].matches[idxM].splKoppel.ingepland;
    ...
    //     //                 kpd.koppelsFirst.sort(this.compareRondeKoppels);
    //     //             }
    //     //             else if (matchKpl.koppel.voorkeurDagen[1] == kpd.dagNr) {
    //     //                 kpd.koppelsSecond.push(matchKpl);
    //     //                 kpd.koppelsSecond.sort(this.compareRondeKoppels);
    //     //             }
    //     //             else {
    //     //                 kpd.koppelsRest.push(matchKpl);
    //     //                 kpd.koppelsRest.sort(this.compareRondeKoppels);
    //     //             }
    //     //         }
    //     //     });
    //     // });
    ...
    //             result.push(...this.getRondeKoppelsFromPoule(poule));
    //         }
    //     });
    //     return result;
    // }
    ...
    // private getRondeKoppelsFromPoule(pl: Poule): RondeKoppel[] {
    //     let result: RondeKoppel[] = [];
